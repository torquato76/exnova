...
def estrategia_LSTrader_Garragale(ativos, valor_entrada, tipo):
    ...
    print(yellow + '***************************************************************************************')
    print("\n>>>Iniciando Logan Smith Trader_Garra")
                    ...
                    if volatilidade >= volatility_threshold:
                        ...
                        if volume_ultima >= min_volume:
                            ...
                            if segundos < 30:
                                ...
                                estrategia_LSTrader_Garragale(ativos, valor_entrada, tipo)                                                 
                        else:
...
def catag(all_asset,API):
    ...
    def GARRA(vela1):
        ...
        for par in pares_abertos:
            ...
            calcula_resultado(par, 'GARRA', dici_result)
...
print(yellow + '***************************************************************************************')
print(green +'>>'+white+'  Logan Smith Trader -  Robô Garra/Martingale') 
